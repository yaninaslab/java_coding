public class SavingsAccount {
    ...
    public void addMoney(int balanceEuro) {
        // Complete this method
        this.balanceEuro += balanceEuro;
        System.out.println("Adding " + balanceEuro + " dollars to the account.");
        System.out.println("The new balance is " + this.balanceEuro + " dollars");
    }
    ...
    public static void main(String[] args) {
        ...
        zeusSavingsAccount.addMoney(1000);
